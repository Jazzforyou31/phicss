...
if (isset($_POST['news_id'], $_POST['news_title'], $_POST['news_description'], $_POST['message'], $_POST['category'], $_POST['news_date'], $_POST['author'])) {
    ...
    $result = $newsClass->updateNewsById($newsId, $newsTitle, $newsDescription, $message, $category, $newsDate, $author);
